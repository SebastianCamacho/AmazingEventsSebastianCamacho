...
evento=Datos.eventos.find(e => e._id==id)
...
let estimado=document.getElementById("estimadaDetails")
...
descripcion.innerHTML=evento.descripción
fecha.innerHTML=evento.fecha
categoria.innerHTML=evento.categoría
lugar.innerHTML=evento.lugar
capacidad.innerHTML=evento.capacidad
estimado.innerHTML=evento.estimación
